...
ReproduceSupplementaryData <- function(GitHub_path){
  ...
  saveWorkbook(SupplementaryData, paste(GitHub_path, "Data/SupplementaryData.xlsx", sep=""))
}
...
ReproduceFigures <- function(GitHub_path){
  ...
  png(paste(GitHub_path, "Figures/CloneTrack_RelDiv_reproduced.png", sep=""), width = 8000, height = 8000, units = "px")
  plot.new()
  ...
  png(paste(GitHub_path, "Figures/VJUsage_reproduced.png", sep=""), width = 5500, height = 6000, units = "px")
  plot.new()
