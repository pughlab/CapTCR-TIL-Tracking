...
cfDNA_clonetrack <- function(patient, sampcohort, chain, clnefrc, primary){
  
  Load_data(patient, "cfDNA", chain, clnefrc)
  cfDNA_clones <- CDR3_fraction$aaSeqCDR3[which(CDR3_fraction$filename==eval(as.name(paste0(patient,"cfDNA")))[2])]
