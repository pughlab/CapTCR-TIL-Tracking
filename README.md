...
The current understanding of the contents, diversity, and changes in the antigen-experienced T-Cell Receptor (TCR) repertoire after adoptive-cell transfer (ACT) of in-vitro Tumor-Infiltrating Lymphocytes (TIL) is limited. Previous studies have shown that an increased number of TIL’s correlates with patient response (32) yet the diversity of the TIL-infusion product has been seen to have no impact on patient response  (27, 29, 20).  In this study, we sought to determine 1) whether T cell repertoire diversity of ACT infusion product at delivery is associated with response and 2) whether ACT response and relapse can be accurately predicted and tracked through serial blood draws.  In this study, 10 patients with cutaneous melanoma, mucosal melanoma, breast, or ovarian cancer were each given TIL ACT after chemodepletion. Peripheral blood cells and cell-free DNA were collected before and after the transfer, as well as every 3 months afterward. TCR repertoire was isolated using the CapTCR-seq assay followed by comparison of TCR diversity and clonal tracking for each patient. The efficacy of CapTCR-seq was confirmed for the tracking of TIL ACT in Peripheral Blood Mononuclear Cells (PBMCs). Further analysis revealed that an increased amount of hyper-expansive clones (>5% of repertoire) were present in higher response patients. These highly expanded TIL-clones were found to not be highly prevalent in the infusion as the top 50% of the TCR repertoire 4 weeks after the infusion came from only a median of 0.51% of the TIL-infusion product. These results depict effective tracking methodologies for TIL ACT as well as a selective-expansion of TIL clones in vivo.
