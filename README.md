...
The current understanding of the contents, diversity, and changes in the antigen-experienced T-Cell Receptor (TCR) repertoire after adoptive-cell transfer (ACT) of in-vitro Tumor-Infiltrating Lymphocytes (TIL) is limited. Previous studies have explored the role of the TIL-infusion product diversity in ACT as well as the role of expansion in patient outcomes. This study aims to determine the tracking efficacy of CapTCR-seq for TIL adoptive cell transfer tracking and to increase understanding of expansion dynamics. In this study, 10 solid tumor patients were each given TIL adoptive cell transfer after chemodepletion and blood draws were collected before and after the transfer. Genetic information was extracted from the samples and analyzed through the CapTCR-seq pipeline. The efficacy of CapTCR-seq was confirmed for the tracking of TIL ACT in Peripheral Blood Mononuclear Cells (PBMCs). Further analysis revealed that an increased clonality in post-infusion samples were correlated with a higher expansion of TIL-clones. These highly expanded TIL-clones were found to not be highly prevalent in the infusion. These results depict effective tracking methodologies for TIL ACT.  In addition, the results suggest an in vivo dynamic responsible for specific TIL expansion.
